...
int main(int argc, char **argv) {
  ...
  leftWheelPub = n.advertise<std_msgs::Float64>("/left_wheel_controller/cmd_vel", queue_size=100);
  rightWheelPub = n.advertise<std_msgs::Float64>("/right_wheel_controller/cmd_vel", 100);
